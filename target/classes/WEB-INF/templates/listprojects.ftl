...
<ul class="collection">
<#list lists as list>
      <li align="left" class="collection-item teal lighten-2">
      
      ${list.id}. &nbsp;&nbsp;&nbsp;&nbsp; ${list.content} 
      
      </li> 
      <#assign i = 1>
      <#list list.persons as person> <li align="left" class="collection-item">
      
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ${i}. &nbsp; ${person.name} ${person.surname} ${person.index}
      <#assign i++>
      </li></#list>    
 </#list>     
 </ul>
