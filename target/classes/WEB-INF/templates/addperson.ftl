...
<form class="form-style-6" action="/projects/addperson/add" method="POST">
<div class="input-field col s12">
    <select id="nameProject" name="nameProject">
      <option value="" disabled selected>Wybierz projekt</option>
      <#list titleList as title>
      <option id="nameProject" name="nameProject" value="${title.content}">    
      ${title.content}    
      </option>
       </#list>
    </select>
